...
sender_data=st.text_input("Enter sender address")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_data=st.text_input("Enter receiver address")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(record= Record(sender_data,receiver_data,amount), creator_id=8726, prev_hash=prev_block_hash)
